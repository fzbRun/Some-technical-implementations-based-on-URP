...
[ExecuteInEditMode]
public class LightProbeGroupHealper : MonoBehaviour
{
    ...
    public void Bake()
    {
        ...
        AssetDatabase.CreateAsset(IrradianceVolume_SH0, "Assets/test/Global illumination/Volume probe/texture/IrradianceVolume_SH0.asset");
        AssetDatabase.CreateAsset(IrradianceVolume_SH1, "Assets/test/Global illumination/Volume probe/texture/IrradianceVolume_SH1.asset");
        AssetDatabase.CreateAsset(IrradianceVolume_SH2, "Assets/test/Global illumination/Volume probe/texture/IrradianceVolume_SH2.asset");
        AssetDatabase.CreateAsset(IrradianceVolume_SH3, "Assets/test/Global illumination/Volume probe/texture/IrradianceVolume_SH3.asset");
        AssetDatabase.CreateAsset(VisibilityVolume_SH0, "Assets/test/Global illumination/Volume probe/texture/VisibilityVolume_SH0.asset");
        AssetDatabase.CreateAsset(VisibilityVolume_SH1, "Assets/test/Global illumination/Volume probe/texture/VisibilityVolume_SH1.asset");
        AssetDatabase.CreateAsset(VisibilityVolume_SH2, "Assets/test/Global illumination/Volume probe/texture/VisibilityVolume_SH2.asset");
        AssetDatabase.CreateAsset(VisibilityVolume_SH3, "Assets/test/Global illumination/Volume probe/texture/VisibilityVolume_SH3.asset");
